...
class Tunnel:
    ...
    def __init__(
        ...
        Args:
            ...
            http_user: Optional HTTP basic auth username protecting tunnel
                traffic. The password is auto-generated by the backend;
                read it from the http_password property after start().
        """
    ...
    def http_password(self) -> Optional[str]:
        """Get the auto-generated basic auth password (set after start()).

        Only available on the Tunnel instance that created the registration;
        it cannot be retrieved again later.
        """
        return self._tunnel_info.http_password if self._tunnel_info else None
